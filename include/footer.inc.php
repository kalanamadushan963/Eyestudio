                    ...
                    <div class="footer-widget contact-widget">
                        ...
                        <div class="widget-content">
                            <ul class="info-list clearfix">
                                <li><i class="fas fa-map-marker-alt"></i>Eye Studio Dubai - 27 A St Jumeirah - Dubai, Dubai</li>
    ...
    <div class="footer-bottom">
        <div class="auto-container">
            <div class="inner-box clearfix">
                <figure class="footer-logo"><a href="index.html"><img src="assets/images/footer-logo1.png" alt=""></a></figure>
                <div class="copyright pull-left">
                    <p><a href="index.html">Eye Studio</a> &copy; 2026 All Right Reserved</p>
                </div>
